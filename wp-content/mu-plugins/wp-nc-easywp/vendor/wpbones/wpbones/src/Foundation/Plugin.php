...
class Plugin extends Container implements PluginContract
{
    ...
    public function boot()
    {
         ...
         *
         ...
         Description = "WPNCEasyWP is a WP Bones boilperate plugin"
        ...
        // Load text domain
        load_plugin_textdomain("wpnceasywp", false, trailingslashit(basename($this->basePath)) . $this->pluginData['DomainPath']);
     ...
     *
     * @return \WPNCEasyWP\WPBones\View\View
     */

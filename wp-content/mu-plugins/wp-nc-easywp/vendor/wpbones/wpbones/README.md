...
You can use [WPNCEasyWP](https://github.com/wpbones/WPNCEasyWP) repo as a boilerplate to create a plugin.
...
You may start from [WPNCEasyWP](https://github.com/wpbones/WPNCEasyWP) repo as a boilerplate to create a WP Bones WordPress plugin.
